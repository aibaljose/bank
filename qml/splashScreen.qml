...
Window {
    ...
    Rectangle {
        ...
        Label {
            ...
            opacity: 0
            color: "#55aaff"
            text: "Aibal Techy -  By: Aibal Jose"
    ...
    Rectangle{
        ...
        Label {
            ...
            y: 50
            color: "#ffffff"
            text: qsTr("Aibal Securite center")
            font.weight: Font.DemiBold
            font.bold: true
            font.pointSize: 14
            font.family: "Segoe UI"
       ...
       // AnimatedImage { id: animation; source: "animation.gif" }
        AnimatedImage {
            ...
            PropertyAnimation{
                ...
                target: imageFingerPrint
                property: "opacity"
                to: if(imageFingerPrint.opacity == 0) return 1; else return 0
                duration: 500
                easing.type: Easing.InOutQuint
            }
        }
